...
static inline float balanceHeuristic(float pdf0, float pdf1, float n0, float n1)
{
    return (pdf0*n0)/(pdf0*n0 + pdf1*n1);
}

static inline float balanceHeuristic(float pdf0, float pdf1, float pdf2, float n0, float n1, float n2)
{
    return (pdf0*n0)/(pdf0*n0 + pdf1*n1 + pdf2*n2);
}
