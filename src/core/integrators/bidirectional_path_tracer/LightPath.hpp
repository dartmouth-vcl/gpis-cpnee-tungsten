...
public:
    ...
    void tracePath(const TraceableScene &scene, TraceBase &tracer, PathSampleGenerator &sampler, Vec4u pixelSampleSegment, bool fromCamera, int length = -1, bool prunePath = true);
