...
public:
    ...
    virtual Vec3f evalGrad(const SurfaceScatterEvent &event) const {
        std::cout << "Bsdf::evalGrad() not implemented!\n";
        return Vec3f(0.f);
    };
    ...
    virtual DirectionCircle getScatteringCircle(const SurfaceScatterEvent &event) const{
        std::cout << "Bsdf::getScatteringCircle() not implemented!\n";
        return DirectionCircle(Vec3f(0.f, 0.f, 1.f));
    }
