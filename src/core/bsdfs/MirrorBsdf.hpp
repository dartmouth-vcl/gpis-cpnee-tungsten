...
public:
    ...
    virtual Vec3f evalGrad(const SurfaceScatterEvent &event) const override;
    virtual bool invert(WritablePathSampleGenerator &sampler, const SurfaceScatterEvent &event) const override;
    virtual float pdf(const SurfaceScatterEvent &event) const override;

    virtual DirectionCircle getScatteringCircle(const SurfaceScatterEvent &event) const override;
};
